(() => {
  ...
  // src/js/main.js
  Promise.resolve().then(() => __toESM(require_preline()));
  (function() {
    "use strict";
    window.onscroll = function() {
      ...
      if (logo.length) {
        if (ud_header.classList.contains("sticky")) {
          document.querySelector(".header-logo").src = "assets/images/logo/logo.svg";
        } else {
    ...
    document.querySelectorAll("#navbarCollapse ul li:not(.submenu-item) a").forEach(
